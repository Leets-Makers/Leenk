...
public enum NotificationType {
	...
	FIRST_FEED_LIKE("새로운 좋아요", "내가 쓴 피드에 좋아요를 받았어 %s"),
	LIKE_COUNT("좋아요", "내가 쓴 피드에 좋아요를 %d개 받았어");
	...
	public String getFormattedContent(long likeCount){
		return String.format(content, likeCount);
	}
}
